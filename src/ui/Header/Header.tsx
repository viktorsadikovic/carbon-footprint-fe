...
import { Box, styled, Switch, TextField } from "@mui/material";
...
export function Header(): JSX.Element {
  const activeTheme = () =>
    useAppSelector(selectActiveTheme) == SupportedThemes.DARK;
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    dispatch(setActiveTheme(themeValue as SupportedThemes));
    ...
    <StyledHeader>
      {isLoggedIn && (
        <>
          ...
          <MaterialUISwitch checked={activeTheme()} onChange={handleChange} />
        </>
      )}
    </StyledHeader>
  );
